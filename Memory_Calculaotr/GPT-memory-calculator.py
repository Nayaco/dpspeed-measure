...
# Weight + bias
weights_Mem = vocabularySize * hiddenDimension / tensorParallelSize + positionEmbeddings * hiddenDimension + (12 * hiddenDimension 
    * hiddenDimension / tensorParallelSize + (6+7/tensorParallelSize) * hiddenDimension) * transformerLayers + 2 * hiddenDimension

# Weight Memory, MB
weights_Mem_FP16 = weights_Mem * 2 / 1024 /1024 / 1024
weights_Mem_FP32 = weights_Mem * 4 / 1024 /1024 / 1024
